...
{ 
	...
	SAFECUDAMEMCPY(d_idx_s, idx_s,ndim*sizeof(int), hipMemcpyHostToDevice); 
	SAFECUDAMEMCPY(d_lda_s, temp,ndim*sizeof(int), hipMemcpyHostToDevice); 
	SAFECUDAMEMCPY(d_ldb_s, ldb_s,ndim*sizeof(int), hipMemcpyHostToDevice); 
