...
{ 
	...
	SAFECUDAMEMCPY(d_idx_s, idx_s,newndim*sizeof(int), hipMemcpyHostToDevice); 
	SAFECUDAMEMCPY(d_lda_s, lda_s,newndim*sizeof(int), hipMemcpyHostToDevice); 
	SAFECUDAMEMCPY(d_ldb_s, temp,newndim*sizeof(int), hipMemcpyHostToDevice); 
